...
public class CancelReserveisminventoryResponse {
    ...
    public String toString() {
        ...
        sb.append(CancelReserveisminventoryResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
